...
public class HighlightArraryAdapter extends ArrayAdapter<String> {
    ...
    public HighlightArraryAdapter(Context context, int resource, int textViewResourceId, String[] objects) {
