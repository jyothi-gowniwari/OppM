...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    private MyProductItemClickListener clickListener;
    public boolean isproposal = false;
    private MyProductEditItemClickListner editItemClickListner;


    public ProductAdapter(Context context, ArrayList<ModelTest> modelTests, ProductAdapter.MyProductItemClickListener clickListener, ProductAdapter.MyProductEditItemClickListner editItemClickListner) {
        mContext = context;
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myProductItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myProductEditItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("Product Validation Support Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MyProductItemClickListener {
        void myProductItemClick(int position);
    }

    public interface MyProductEditItemClickListner {
        void myProductEditItemClick(int position);
    }
