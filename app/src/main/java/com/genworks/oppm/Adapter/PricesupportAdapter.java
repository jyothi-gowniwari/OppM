...
public class PricesupportAdapter extends RecyclerView.Adapter<PricesupportAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MyPriceItemClickListener clickListener;
    public boolean isproposal = false;
    private MyPriceEditItemClickListner editItemClickListner;


    public PricesupportAdapter(Context context, ArrayList<ModelTest> modelTests, PricesupportAdapter.MyPriceItemClickListener clickListener, PricesupportAdapter.MyPriceEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public PricesupportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        PricesupportAdapter.MyViewHolder holder = new PricesupportAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final PricesupportAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myPriceItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myPriceEditItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("Price Support Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MyPriceItemClickListener {
        void myPriceItemClick(int position);
    }

    public interface MyPriceEditItemClickListner {
        void myPriceEditItemClick(int position);
    }
