...
public class DemoRequiredAdapter extends RecyclerView.Adapter<DemoRequiredAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MyDemoItemClickListener clickListener;
    public boolean isproposal = false;
    private MyDemoEditItemClickListner editItemClickListner;


    public DemoRequiredAdapter(Context context, ArrayList<ModelTest> modelTests, DemoRequiredAdapter.MyDemoItemClickListener clickListener, DemoRequiredAdapter.MyDemoEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public DemoRequiredAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        DemoRequiredAdapter.MyViewHolder holder = new DemoRequiredAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final DemoRequiredAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myDemoItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myDemoEditItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("Demo Required Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MyDemoItemClickListener {
        void myDemoItemClick(int position);
    }

    public interface MyDemoEditItemClickListner {
        void myDemoEditItemClick(int position);
    }
