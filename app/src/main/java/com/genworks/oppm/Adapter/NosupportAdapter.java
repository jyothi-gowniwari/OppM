...
public class NosupportAdapter extends RecyclerView.Adapter<NosupportAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MySupportItemClickListener clickListener;
    public boolean isproposal = false;
    private MySupportEditItemClickListner editItemClickListner;


    public NosupportAdapter(Context context, ArrayList<ModelTest> modelTests, NosupportAdapter.MySupportItemClickListener clickListener, NosupportAdapter.MySupportEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public NosupportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        NosupportAdapter.MyViewHolder holder = new NosupportAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final NosupportAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myItemSupportClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myEditSupportItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("No Support Required Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MySupportItemClickListener {
        void myItemSupportClick(int position);
    }

    public interface MySupportEditItemClickListner {
        void myEditSupportItemClick(int position);
    }
