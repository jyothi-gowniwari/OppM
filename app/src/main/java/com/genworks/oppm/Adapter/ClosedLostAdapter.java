...
public class ClosedLostAdapter extends RecyclerView.Adapter<ClosedLostAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MyLostItemClickListener clickListener;
    public boolean isproposal = false;
    private MyLostEditItemClickListner editItemClickListner;


    public ClosedLostAdapter(Context context, ArrayList<ModelTest> modelTests, ClosedLostAdapter.MyLostItemClickListener clickListener, ClosedLostAdapter.MyLostEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public ClosedLostAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        ClosedLostAdapter.MyViewHolder holder = new ClosedLostAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final ClosedLostAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myLostItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myLostEditItemClick(position);
                                return true;
                            case R.id.share:
...
//    }
    ...
    public interface MyLostItemClickListener {
        void myLostItemClick(int position);
    }

    public interface MyLostEditItemClickListner {
        void myLostEditItemClick(int position);
    }
