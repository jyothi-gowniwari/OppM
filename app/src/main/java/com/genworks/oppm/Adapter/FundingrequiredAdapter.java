...
public class FundingrequiredAdapter extends RecyclerView.Adapter<FundingrequiredAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MyFundingItemClickListener clickListener;
    public boolean isproposal = false;
    private MyFundingEditItemClickListner editItemClickListner;


    public FundingrequiredAdapter(Context context, ArrayList<ModelTest> modelTests, FundingrequiredAdapter.MyFundingItemClickListener clickListener, FundingrequiredAdapter.MyFundingEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public FundingrequiredAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        FundingrequiredAdapter.MyViewHolder holder = new FundingrequiredAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final FundingrequiredAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myFundingItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myFundingEditItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("Funding Required Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MyFundingItemClickListener {
        void myFundingItemClick(int position);
    }

    public interface MyFundingEditItemClickListner {
        void myFundingEditItemClick(int position);
    }
