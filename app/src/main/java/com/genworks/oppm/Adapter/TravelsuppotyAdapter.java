...
public class TravelsuppotyAdapter extends RecyclerView.Adapter<TravelsuppotyAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private Context mContext;
    private ArrayList<ModelTest> modelTests;
    private MyTravelItemClickListener clickListener;
    public boolean isproposal = false;
    private MyTravelEditItemClickListner editItemClickListner;


    public TravelsuppotyAdapter(Context context, ArrayList<ModelTest> modelTests, TravelsuppotyAdapter.MyTravelItemClickListener clickListener, TravelsuppotyAdapter.MyTravelEditItemClickListner editItemClickListner) {
        mContext = context;
    ...
    @Override
    public TravelsuppotyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.fragment_nego, parent, false);
        TravelsuppotyAdapter.MyViewHolder holder = new TravelsuppotyAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final TravelsuppotyAdapter.MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isproposal=true)
                    ...
                    clickListener.myTravelItemClick(position);
            }
        });
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.edit:
                                editItemClickListner.myTravelEditItemClick(position);
                                return true;
                            case R.id.share:
                                Intent intent=new Intent(Intent.ACTION_SEND);
                                StringBuilder sb = new StringBuilder();
                                sb.append("Travel Support Details : ");
                                sb.append('\n');
...
//    }
    ...
    public interface MyTravelItemClickListener {
        void myTravelItemClick(int position);
    }

    public interface MyTravelEditItemClickListner {
        void myTravelEditItemClick(int position);
    }
