...
public class TaskWeekWiseFragement extends Fragment implements TaskAdapter.MyItemClickListener, TaskAdapter.MyEditItemClickListner {

    public TaskWeekWiseFragement() {
...
//
                ...
                try {
                    Date date = format.parse(modifiedtime);
