...
public class SalesStageFragment extends Fragment implements OpportunityAdapter.MyItemClickListener, OpportunityAdapter.MyEditItemClickListner, OpportunityAdapter.MyPDfItemClickListner, OpportunityAdapter.Listener, ProposalAdapter.MyEditProposalItemClickListner, ProposalAdapter.MyProposalItemClickListener, NosupportAdapter.MySupportEditItemClickListner, NosupportAdapter.MySupportItemClickListener
    ...
    private String Paths,documentIDS;
...
//                                            assigned_tos.add(v);
    ...
    private void workingOnResponse1(final SyncModule syncModule) {
            ...
            public void onResponse(Call<DocumentModel> call, Response<DocumentModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (success.equals("true")) {
                        ...
                        if (purchase_orderModel.equals("purchase_order")) {
                        ...
                        if(checqueModel.equals("checque")) {
                        ...
                        if(doc_oneModel.equals("doc_one")) {
                        ...
                        if(doc_twoModel.equals("doc_two")) {
                  ...
                  //  DocModel docModel1=closedwonList.get(position);
                    ...
                    for (int i = 0; i < arrayDoc; i++) {
                        ...
                        for (int j=0;j<PathList.length;j++){
                            imagepath="http://crmtest.genworkshealth.com/".concat(String.valueOf(PathList[i]));
