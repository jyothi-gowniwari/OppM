...
public class TaskScheduledFragement extends Fragment implements TaskAdapter.MyItemClickListener, TaskAdapter.MyEditItemClickListner {

    public TaskScheduledFragement() {
...
//        });
                ...
                call.enqueue(new Callback<SyncModule>() {
                    ...
                    public void onResponse(Call<SyncModule> call, Response<SyncModule> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            workingOnResponsescheduled(syncModule);
    ...
    @SuppressLint("ResourceAsColor")
    private void workingOnResponsescheduled(SyncModule syncModule){
        isdate=true;
