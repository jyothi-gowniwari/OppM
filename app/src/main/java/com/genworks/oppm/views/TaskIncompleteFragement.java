...
public class TaskIncompleteFragement extends Fragment implements TaskAdapter.MyItemClickListener, TaskAdapter.MyEditItemClickListner {


    public TaskIncompleteFragement() {
...
//        task_all.setBackgroundColor(Color.rgb(31,104,120));
        ...
        if (!apiResponseStr.equals("")){
            ...
            listTask.clear();
            workingOnResponseincomplete(obj);
        }else {
            fetchJSON();
        }
...
//
//                task_incomplete.setBackgroundColor(Color.rgb(31,104,120));
//                incomplete.setTextColor(getResources().getColorStateList(R.color.White));
//                task_all.setBackgroundColor(Color.TRANSPARENT);
//                all.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_schedueld.setBackgroundColor(Color.TRANSPARENT);
//                scheduled.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_weekwise.setBackgroundColor(Color.TRANSPARENT);
//                weekwise.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_today.setBackgroundColor(Color.TRANSPARENT);
//                today.setTextColor(getResources().getColorStateList(R.color.tabs));
//                String apiResponseStr = PreferenceManagerTask.getInstance(requireContext()).getAPIResponseTask(); // so you have to press your refresh buttonok
//                recyclerViewTask.clearFocus();
//                if (!apiResponseStr.equals("")){
//                    Gson gson = new Gson();
//                    SyncModule obj = gson.fromJson(apiResponseStr, SyncModule.class);
//                    listTask.clear();
...
//                task_incomplete.setBackgroundColor(Color.TRANSPARENT);
//                incomplete.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_schedueld.setBackgroundColor(Color.TRANSPARENT);
//                scheduled.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_weekwise.setBackgroundColor(Color.TRANSPARENT);
//                weekwise.setTextColor(getResources().getColorStateList(R.color.tabs));
...
//        });
//
//        weekwise.setOnTouchListener(new View.OnTouchListener() {
//            @SuppressLint("ResourceAsColor")
//            @Override
//            public boolean onTouch(View v, MotionEvent event) {
//
//
//                task_weekwise.setBackgroundColor(Color.rgb(31,104,120));
//                weekwise.setTextColor(getResources().getColorStateList(R.color.White));
//                task_incomplete.setBackgroundColor(Color.TRANSPARENT);
//                incomplete.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_schedueld.setBackgroundColor(Color.TRANSPARENT);
//                scheduled.setTextColor(getResources().getColorStateList(R.color.tabs));
...
//            }
//        });
//        scheduled.setOnTouchListener(new View.OnTouchListener() {
//            @SuppressLint("ResourceAsColor")
//            @Override
//            public boolean onTouch(View v, MotionEvent event) {
//
//
//                task_schedueld.setBackgroundColor(Color.rgb(31,104,120));
//                scheduled.setTextColor(getResources().getColorStateList(R.color.White));
//                task_incomplete.setBackgroundColor(Color.TRANSPARENT);
//                incomplete.setTextColor(getResources().getColorStateList(R.color.tabs));
//                task_all.setBackgroundColor(Color.TRANSPARENT);
//                all.setTextColor(getResources().getColorStateList(R.color.tabs));
...
//                    SyncModule obj = gson.fromJson(apiResponseStr, SyncModule.class);
//                    listTask.clear();
//                    workingOnResponsescheduled(obj);
//                }
//                return true;
//            }
//        });
                ...
                call.enqueue(new Callback<SyncModule>() {
                    ...
                    public void onResponse(Call<SyncModule> call, Response<SyncModule> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            workingOnResponseincomplete(syncModule);
    ...
    @SuppressLint("ResourceAsColor")
    private void workingOnResponseincomplete(SyncModule syncModule){
        isdate=true;
