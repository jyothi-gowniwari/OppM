...
import static com.genworks.oppm.Utils.LogUtils.TAG;

public class TaskAllFragement extends Fragment implements TaskAdapter.MyItemClickListener, TaskAdapter.MyEditItemClickListner {

    public TaskAllFragement() {
