...
public class TaskFragement extends Fragment implements TaskAdapter.MyItemClickListener, TaskAdapter.MyEditItemClickListner {

    public TaskFragement() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.account_listtwo, container, false);
        ...
        fragment = new TaskTodayFragement();
        ...
        String apiResponseStr = PreferenceManagerTask.getInstance(requireContext()).getAPIResponseTask();
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        ...
                        ((MainActivity)getActivity()).setActionBarTitle("TASK LIST");
                        fragment = new TaskAllFragement();
                        break;
                    case 2:
                        isDuplicate=true;
                        ((MainActivity)getActivity()).setActionBarTitle("TASK LIST");
                        fragment = new TaskIncompleteFragement();
                        break;
                    case 3:
                        isDuplicate=true;
                        ((MainActivity)getActivity()).setActionBarTitle("TASK LIST");
                        fragment = new TaskScheduledFragement();
                        break;
                    case 4:
                        isDuplicate=true;
                        ((MainActivity)getActivity()).setActionBarTitle("TASK LIST");
                        fragmentClass = TaskWeekWiseFragement.class;
                        break;
                }
                try {
...
//                            workingOnResponseweekwise(syncModule);
    ...
    public void initSearchView() {
        ...
        txtSearch.setHintTextColor(R.color.linecolor);
    ...
    @SuppressLint("ResourceAsColor")
    private void workingOnResponsedatewise(final SyncModule syncModule) {
        loadingDialog.show();
