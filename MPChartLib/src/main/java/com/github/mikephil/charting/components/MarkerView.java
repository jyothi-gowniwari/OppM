...
public class MarkerView extends RelativeLayout implements IMarker {
    ...
    /**
     * Constructor. Sets up the MarkerView with a custom borderdashboard resource.
     *
     * @param context
     * @param layoutResource the borderdashboard resource to use for the MarkerView
     */
    ...
    /**
     * Sets the borderdashboard resource for a custom MarkerView.
     *
